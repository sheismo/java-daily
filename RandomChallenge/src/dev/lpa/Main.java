...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Game Over. Real dev.lpa.game would score and continue.");
    }
    ...
    private static void rollDice (List<Integer> currentDice) {
        ...
        System.out.println("Your dev.lpa.dice are: " + currentDice);
    }
    ...
    private static boolean pickLosers(List<Integer> currentDice) {
        String prompt = """
                    ...
                    Type "ALL" to re-roll all the dev.lpa.dice.
                    List numbers (separated by spaces) to re-roll selected dev.lpa.dice. 
                """;
