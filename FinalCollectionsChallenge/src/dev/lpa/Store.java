...
public class Store {
    ...
    private void stockStore() {
        ...
        List<Product> products = new ArrayList<>(List.of(
                ...
                new Product("Y001", "yoghurt", "farm", Category.DAIRY),
                new Product("C333", "cheese", "farm", Category.DAIRY),
                new Product("R777", "rice chex", "Nabisco", Category.CEREAL),
                new Product("G111", "granola", "Not Valley", Category.CEREAL),
        ...
        products.forEach(p -> inventory.put(p.sku(), new InventoryItem(random.nextDouble(0, 1.25), p, 1000, 5)));
    }
