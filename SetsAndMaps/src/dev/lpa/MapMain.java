...
//                System.out.println("current = " + contact);
        ...
        contacts.forEach((k, v) -> System.out.println("keys=" + k + ", value= " + v));
        ...
        System.out.println("updateDaisy = + updatedDaisy");
        boolean success = contacts.replace("Daisy Duck", daisy, updatedDaisy);
        if (success) {
            System.out.println("Successfully replaced element");
        } else {
            System.out.printf("Did not match on both key: %s and value: %s  %n%n", "Daisy Duck", replacedContact);
        }
        contacts.forEach((k, v) -> System.out.println("key=" + k + ", value= " + v));
