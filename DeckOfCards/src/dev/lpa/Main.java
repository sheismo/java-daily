...
public class Main {
    public static void main(String[] args) {
        ...
        Card aceOfHearts = Card.getFaceCard(Card.Suit.HEART, 'J');
...
//        Collections.addAll(cards, cardArray);
        ...
        System.out.println("Worst card = " + Collections.max(deck, sortingAlgorithm));
        ...
        List<Card> copied2 = new ArrayList<>(deck.subList(0, 13));
        Collections.rotate(copied2, -2);
        System.out.println("UnRotated: " + deck.subList(0, 13));
        System.out.println("Rotated: " + -2 + ": " + copied2);
