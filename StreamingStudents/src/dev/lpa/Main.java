...
public class Main {
    public static void main(String[] args) {
        ...
        Course jmc = new Course("JMC", "Python MasterClass");

//        Student tim = new Student("AU", 2024, 30, "M", true, jmc, pymc);
//        System.out.println(tim);
//
//        tim.watchLecture("JMC", 10, 5, 2024);
//        tim.watchLecture("PYMC", 7, 10, 2024);
//        System.out.println(tim);
        ...
        var maleStudents = Arrays.stream(students)
                        .filter(ms -> ms.getGender().equals("M"));
        ...
        long longTermCount = Arrays.stream(students)
                ...
                .count();
        System.out.println("no of longTerm students? " + longTermCount);
